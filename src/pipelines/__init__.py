...
from src.pipelines.processing.event_standardization import standardize_events
from src.pipelines.processing.sessionization import make_user_session
...
def prepare_data(spark: SparkSession):
    ...
    # Etapa 5: Padroniza o formato final dos eventos para consumo
    standardize_events(spark=spark)

    print("Pipeline de preparação de dados concluído com sucesso!")
